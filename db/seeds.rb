...
warrior.save
warrior = Warrior.new(id: 2,name: 'Un super-héros évoluant dans l\'univers Marvel de la maison d\'édition Marvel Comics.', description: 'The friendliest and furriest
  resident of Project Pegasus, Goose is the affectionate tabby cat that joins
...
warrior.save
warrior = Warrior.new(id: 3,name: 'Eminem', description: 'Un rappeur américain, également producteur, acteur, et fondateur de label. Un guerrier de RAP Game.', level: 3, strength: 6, armor:6)
  warrior.image = Pathname.new(Rails.root.join("app/assets/images/téléchargement.jpeg")).open
  warrior.save
warrior = Warrior.new(id: 4,name: 'Kung Fury', description: 'Kung Fury, détective de la police de Miami dans les années 80. Un guerrier d\'arts martiaux',level: 4, strength: 8, armor:8)
warrior.image = Pathname.new(Rails.root.join("app/assets/images/kung-fury.jpg")).open
warrior.save
warrior = Warrior.new(id: 5,name: 'The Gopnik', description: 'Un guerrier sans peur, ayant toujour une bière dans une main et des graines de tournesol
